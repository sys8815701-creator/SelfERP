      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px", marginBottom: "28px" }}>
        {[
          ...
          <div
            ...
            style={{ backgroundColor: "var(--bg-surface)", border: "1px solid var(--border)", borderRadius: "14px", padding: "20px 24px", cursor: "pointer", transition: "box-shadow 0.15s" }}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px" }}>
          {SHORTCUTS.map(s => (
            <div
              ...
              style={{ display: "flex", alignItems: "center", gap: "12px", padding: "14px 16px", backgroundColor: "var(--bg-surface-2)", borderRadius: "10px", cursor: "pointer", border: "1px solid var(--border)", transition: "background 0.15s" }}
