                      ...
                      <td style={{ padding: "14px 16px", textAlign: "right" }}>
                        <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
                          ...
                          <button onClick={() => rejectUser(u.id)} disabled={userProcessing === u.id}
                            style={{ padding: "6px 14px", borderRadius: "8px", backgroundColor: "transparent", border: "1.5px solid #EF4444", color: "#EF4444", fontSize: "12px", fontWeight: 700, cursor: "pointer", opacity: userProcessing === u.id ? 0.7 : 1 }}>
                            거절
                          </button>
                        </div>
                      </td>
          ...
          <div style={{ display: "flex", gap: "4px", marginBottom: "20px" }}>
            {(["pending", "all", "approved", "rejected"] as const).map(f => (
              <button key={f} onClick={() => setFilter(f)}
                style={{ padding: "7px 18px", borderRadius: "8px", border: "none", cursor: "pointer", fontSize: "13px", fontWeight: 600,
                  backgroundColor: filter === f ? "var(--accent)" : "var(--bg-surface-2)",
              ...
              <div style={{ backgroundColor: "var(--bg-surface)", borderRadius: "20px", padding: "32px", width: "480px", border: "1px solid var(--border)" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "10px" }}>
                  ...
                  <button onClick={() => review(selected.id, "reject")} disabled={processing}
                    style={{ padding: "11px", borderRadius: "9px", border: "1.5px solid #EF4444", backgroundColor: "transparent", color: "#EF4444", fontSize: "13px", fontWeight: 700, cursor: "pointer", opacity: processing ? 0.7 : 1 }}>
                    거절
                  </button>
                      ...
                      <td style={{ padding: "14px 16px", textAlign: "right" }}>
                        <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
                          ...
                          <button onClick={() => rejectJoin(r.id)} disabled={joinProcessing === r.id}
                            style={{ padding: "6px 14px", borderRadius: "8px", backgroundColor: "transparent", border: "1.5px solid #EF4444", color: "#EF4444", fontSize: "12px", fontWeight: 700, cursor: "pointer", opacity: joinProcessing === r.id ? 0.7 : 1 }}>
                            거절
                          </button>
                        </div>
                      </td>
