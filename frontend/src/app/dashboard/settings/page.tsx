      ...
      <div style={{ ...card, borderColor: "rgba(239,68,68,0.25)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <button onClick={handleLogout}
            style={{ display: "flex", alignItems: "center", gap: "7px", padding: "9px 18px", backgroundColor: "rgba(239,68,68,0.12)", color: "#EF4444", border: "1.5px solid rgba(239,68,68,0.40)", borderRadius: "9px", fontSize: "13px", fontWeight: 700, cursor: "pointer" }}>
            <LogOut size={14} />로그아웃
          </button>
