    ...
    <div style={{ width: "100%" }}>
      ...
      {alerts.length > 0 && (
        <div onClick={() => router.push("/dashboard/production/efficiency")}
          style={{ backgroundColor: "#FEF2F2", border: "1px solid #FCA5A5", borderRadius: "12px", padding: "12px 18px", marginBottom: "20px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
