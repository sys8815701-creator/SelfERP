                ...
                <tr key={bom.id}
                  ...
                  <td style={{ padding: "12px 14px" }}>
                    <button onClick={e => { e.stopPropagation(); handleDelete(bom.id); }}
                      disabled={deleting}
                      style={{ fontSize: "11px", color: "#DC2626", backgroundColor: "rgba(220,38,38,0.12)", border: "1px solid rgba(220,38,38,0.40)", borderRadius: "6px", padding: "3px 7px", cursor: "pointer" }}>삭제</button>
                  </td>
                </tr>
              ))}
            </tbody>
