                  ...
                  <tr key={lv.id} style={{ borderTop: i === 0 ? "none" : "1px solid var(--border-subtle)" }}
                    ...
                    <td style={{ padding: "13px 14px" }}>
                      <div style={{ display: "flex", gap: "6px", justifyContent: "flex-end" }}>
                        ...
                        {canDelete(role) && <button onClick={() => deleteLeave(lv.id)} style={{ padding: "5px 10px", borderRadius: "7px", border: "1px solid rgba(239,68,68,0.3)", backgroundColor: "transparent", cursor: "pointer", fontSize: "12px", color: "#EF4444", fontWeight: 600 }}>삭제</button>}
                      </div>
                    </td>
                  </tr>
                );
