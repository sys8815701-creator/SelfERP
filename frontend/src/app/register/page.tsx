                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    ...
                    <button onClick={bizNumVerified ? () => { setBizNumVerified(false); setBizNumError(""); } : verifyBizNum}
                      ...
                      style={{ padding: "14px 16px", borderRadius: "12px", border: "none", cursor: "pointer", whiteSpace: "nowrap", fontWeight: 700, fontSize: "14px",
                        backgroundColor: bizNumVerified ? "#22C55E" : "var(--accent-light)", color: bizNumVerified ? "white" : "var(--accent)", border: bizNumVerified ? "none" : "1.5px solid #C49A30", opacity: bizNumVerifying ? 0.7 : 1 }}>
